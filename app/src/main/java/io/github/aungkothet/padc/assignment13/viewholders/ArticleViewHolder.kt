package io.github.aungkothet.padc.assignment13.viewholders
...
class ArticleViewHolder(itemView: View, delegate: ArticleItemDelegate) :
    BaseViewHolder<ArticleVO>(itemView) {
